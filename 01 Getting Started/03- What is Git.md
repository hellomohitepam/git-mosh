...
In a **Distributed** system each team member has a full copy of the code and repository in its machine, if the server goes offline they can keep on working
