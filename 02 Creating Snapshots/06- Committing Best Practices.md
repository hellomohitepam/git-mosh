...
Our commits should not be too small neither too big. We do not want to commit every time we change a file, neither we want to wait until we implement a featured end to end before committing.
